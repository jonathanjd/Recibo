          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <span class="label label-warning">{{ $detail->estado }}</span> @else
                <span class="label label-success">{{ $detail->estado }}</span> @endif
              </td>
              <td>
                @if($detail->entregado == 'Si')
                <span class="label label-success">{{ $detail->entregado }}</span> @else
                <span class="label label-warning">{{ $detail->entregado }}</span> @endif
              </td>
              <td>
